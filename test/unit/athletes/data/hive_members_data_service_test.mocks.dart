...
// in coach_app/test/unit/athletes/data/hive_members_data_service_test.dart.
...
class MockLoggerRepository extends _i1.Mock implements _i5.LoggerRepository {
  ...
  @override
  _i4.Stream<_i6.LogEntry> get logStream => (super.noSuchMethod(
        Invocation.getter(#logStream),
        returnValue: _i4.Stream<_i6.LogEntry>.empty(),
      ) as _i4.Stream<_i6.LogEntry>);
  ...
  @override
  _i4.Future<List<_i6.LogEntry>> getLogsByPage(
    int? page,
    int? pageSize,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i4.Future<List<_i6.LogEntry>>.value(<_i6.LogEntry>[]),
      ) as _i4.Future<List<_i6.LogEntry>>);
}

...
// in domain/test/unit/features/antenna_system/state_machine/calibration_state_test.dart.
...
import 'package:domain/features/antenna_system/value_objects/antenna_config.dart'
    as _i6;
import 'package:domain/features/logging/entities/log_entry.dart' as _i12;
import 'package:domain/features/logging/repositories/logger.dart' as _i11;
...
/// A class which mocks [CalibrationService].
///
/// See the documentation for Mockito's code generation for more information.
class MockCalibrationService extends _i1.Mock
    implements _i7.CalibrationService {
  MockCalibrationService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i8.CalibrationResult?> startCalibration() => (super.noSuchMethod(
        Invocation.method(
          #startCalibration,
          [],
        ),
        returnValue: _i4.Future<_i8.CalibrationResult?>.value(),
      ) as _i4.Future<_i8.CalibrationResult?>);

  @override
  void handleCalibrationResponse(_i5.ScanRfCommand? command) =>
      super.noSuchMethod(
        Invocation.method(
...
class MockAntennaCommandRepository extends _i1.Mock
    implements _i9.AntennaCommandRepository {
  ...
  @override
  _i4.Future<void> sendCommandToAll(_i10.Uint8List? command) =>
      (super.noSuchMethod(
        Invocation.method(
          #sendCommandToAll,
          [command],
...
/// A class which mocks [ScanRfCommand].
///
/// See the documentation for Mockito's code generation for more information.
class MockScanRfCommand extends _i1.Mock implements _i5.ScanRfCommand {
  MockScanRfCommand() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  set frequency(int? _frequency) => super.noSuchMethod(
        Invocation.setter(
          #frequency,
          _frequency,
        ),
  ...
  @override
  List<int> get rssiData => (super.noSuchMethod(
        Invocation.getter(#rssiData),
        returnValue: <int>[],
      ) as List<int>);

  @override
  set rssiData(List<int>? _rssiData) => super.noSuchMethod(
        Invocation.setter(
          #rssiData,
          _rssiData,
        ),
  ...
  @override
  _i10.Uint8List generatePayload() => (super.noSuchMethod(
        Invocation.method(
          #generatePayload,
          [],
        ),
  ...
  @override
  void setArbitraryPayload(_i10.Uint8List? payload) => super.noSuchMethod(
        Invocation.method(
          #setArbitraryPayload,
          [payload],
        ),
  ...
  @override
  _i10.Uint8List getPayload() => (super.noSuchMethod(
        Invocation.method(
          #getPayload,
          [],
        ),
  ...
  @override
  _i10.Uint8List serialize() => (super.noSuchMethod(
        Invocation.method(
          #serialize,
          [],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockCommand extends _i1.Mock implements _i5.Command {
  MockCommand() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockLoggerRepository extends _i1.Mock implements _i11.LoggerRepository {
  MockLoggerRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Stream<_i12.LogEntry> get logStream => (super.noSuchMethod(
        Invocation.getter(#logStream),
        returnValue: _i4.Stream<_i12.LogEntry>.empty(),
      ) as _i4.Stream<_i12.LogEntry>);
  ...
  @override
  _i4.Future<List<_i12.LogEntry>> getLogsByPage(
    int? page,
    int? pageSize,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i4.Future<List<_i12.LogEntry>>.value(<_i12.LogEntry>[]),
      ) as _i4.Future<List<_i12.LogEntry>>);
}

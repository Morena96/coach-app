...
import 'package:coach_app/features/athletes/presentation/widgets/athlete_view_header.dart';
import 'package:coach_app/l10n.dart';

/// A page for viewing an athlete's information.
class AthleteViewPage extends ConsumerWidget {
  const AthleteViewPage({
    super.key,
      ...
      child: PageLayout(
        header: athleteState.maybeWhen(
          data: (athlete) => PageHeader(
            titleWidget: AthleteViewHeader(athlete: athlete),
            actions: [
            ...
            subtitle: (athlete.sports ?? []).isNotEmpty
                ? AthleteProfileHeader(sports: athlete.sports ?? [])
                : null,
          ),
          orElse: () => null,
        ),

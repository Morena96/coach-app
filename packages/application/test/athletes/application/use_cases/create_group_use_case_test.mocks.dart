...
// in application/test/athletes/application/use_cases/create_group_use_case_test.dart.
...
class _FakeValidationLibrary_2 extends _i1.SmartFake
    implements _i4.ValidationLibrary {
  _FakeValidationLibrary_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAvatarRepository extends _i1.Mock implements _i12.AvatarRepository {
  MockAvatarRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<_i3.Avatar> saveAvatar(
    String? id,
    _i13.ImageData? imageData,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #saveAvatar,
        ...
        returnValue: _i7.Future<_i3.Avatar>.value(_FakeAvatar_1(
          this,
          Invocation.method(
            #saveAvatar,
            [
      ...
      ) as _i7.Future<_i3.Avatar>);

  @override
  _i7.Future<_i13.ImageData?> getAvatarImage(String? avatarId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAvatarImage,
          [avatarId],
        ),
        returnValue: _i7.Future<_i13.ImageData?>.value(),
      ) as _i7.Future<_i13.ImageData?>);
  ...
  @override
  _i7.Future<void> markAvatarAsSynced(_i3.Avatar? avatar) =>
      (super.noSuchMethod(
        Invocation.method(
          #markAvatarAsSynced,
          [avatar],
  ...
  @override
  _i7.Future<_i3.Avatar> getAvatar(String? avatarId) => (super.noSuchMethod(
        Invocation.method(
          #getAvatar,
          [avatarId],
        ),
...
class MockGroupValidationService extends _i1.Mock
    implements _i14.GroupValidationService {
  MockGroupValidationService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.ValidationLibrary get validationLibrary => (super.noSuchMethod(
        Invocation.getter(#validationLibrary),
        returnValue: _FakeValidationLibrary_2(
          this,
          Invocation.getter(#validationLibrary),
        ),
      ) as _i4.ValidationLibrary);

  @override
  _i5.ValidationResult validateGroupData(Map<String, dynamic>? groupData) =>
      (super.noSuchMethod(
        Invocation.method(
          #validateGroupData,
          [groupData],
        ),
        returnValue: _FakeValidationResult_3(
          this,
          Invocation.method(
            #validateGroupData,
            [groupData],
